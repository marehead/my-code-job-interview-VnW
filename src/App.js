...
export default function Interview() {
  return (
    <>
      ...
      <p>
        My name is Marina i have 20 years and i'm genderqueer, actualy my
        background is director of photography and in future frontend programmer
        and system analyst{" "}
      </p>
      <h3>What language is your favorite ? </h3>
      <p>
        Currently i'm coding using javascript and python abecause as entrepraise
        need
      </p>
